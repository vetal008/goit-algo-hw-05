...
def input_error(func):
    def inner(*args, **kwargs):
        try:
            ...
            return Fore.RED + 'Need more params' + Style.RESET_ALL
        except ValueError:
            return Fore.RED + "Input 'str' for [name] and 'int' for [phone]" + Style.RESET_ALL
        except KeyError:
            return Fore.RED + 'No such contact in list' + Style.RESET_ALL
    return inner
...
def get_all_phones(phone_numbers, *args):
    if phone_numbers:
        ...
        return Fore.RED + 'Do not neet params' + Style.RESET_ALL
    else:
        return Fore.RED + 'No phone numbers' + Style.RESET_ALL
...
def change_phone(phone_numbers, *args):
    if (len(args)) > 2:
        ...
        phone_numbers[args[0]] = int(args[1])
        return Fore.YELLOW + 'Contact changed(Or created new one).' + Style.RESET_ALL
...
def main():
    ...
    while True:
        ...
        match str(first_param):
            ...
            case 'all':
                print(get_all_phones(phone_numbers))
